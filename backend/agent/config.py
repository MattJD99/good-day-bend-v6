...
MODEL_RESEARCH = "gemini-1.5-flash-002"                # The "Researcher" — fast data ingestion (GA)
MODEL_WRITING = "gemini-1.5-pro-002"                   # The "Writer" — best quality for articles (GA)
MODEL_WRITING_BACKUP = "gemini-1.5-flash-002"          # Backup if Pro quota exhausted (GA)
MODEL_REASONING = "gemini-1.5-flash-002"               # Strategy and analysis (GA)
MODEL_VISION = "gemini-1.5-flash-002"                  # Vision/extraction tasks (GA)
MODEL_IMAGE_FAST = "imagen-3.0-generate-001"           # Imagen 3 — photorealistic (GA)
