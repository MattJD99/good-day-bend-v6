...
def build_approval_email(title: str, topic: str, image_url: str, draft_url: str) -> str:
    ...
    Matches V6 style: review links, hero image, feedback stars.
    """
    ...
    <div style="font-family: sans-serif; color: #333;">
        <h1 style="color:#0d1b12;">Good Day Bend Daily Approval</h1>
        ...
        <p style="font-size: 12px; color: #999; margin-top: 10px;"><em>V7 Agent: Gemini 2.5 Pro + Imagen 4 + Art Director Pattern</em></p>
    </div>
    """
